...
function CreateStudent() {
    const { handleChangeMenu } = useContext(MenuContext);
    ...
    const handleSubmit = async (e) => {
        ...
        if (createRes.data) {
            setLoading(false);
            handleChangeMenu("Student Manager");
            navigate("/fs-react/student-manager")
        }
    }
    return (
        <>
                        ...
                        <form onSubmit={handleSubmit} className="w-100">
                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    ...
                                    <Link to={"/fs-react/student-manager"} onClick={() => handleChangeMenu("Student Manager")} className="btn btn-dark">
